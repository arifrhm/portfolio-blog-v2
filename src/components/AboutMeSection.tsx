        ...
        <div className="relative mt-36 w-full max-w-[979px] max-md:mt-10 max-md:max-w-full">
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[18%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col pr-3.5 text-3xl font-bold leading-8 text-neutral-700 dark:text-neutral-300 max-md:mt-10">
                <div>A little </div>
                <div>about me</div>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-[82%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow pr-6 pb-10 mt-10 text-base leading-6 text-neutral-700 dark:text-neutral-400 max-md:max-w-full">
        ...
        <div className="mt-0 w-full max-w-[979px] max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col w-[61%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col mt-7 text-base leading-6 text-neutral-700 dark:text-neutral-300 max-md:mt-10">
                ...
                <div className="mt-11 underline text-neutral-700 dark:text-neutral-300 max-md:mt-10">
                  Download my CV
                </div>
              </div>
            </div>
            <div className="flex flex-col ml-5 w-[39%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-start py-14 pl-12 w-full text-base leading-6 bg-black text-zinc-100 dark:bg-gray-800 dark:text-zinc-300 max-md:mt-10">
